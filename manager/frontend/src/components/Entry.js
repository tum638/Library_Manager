...
const Entry = () => {
  ...
  const [ accnumber, setAcc ] = useState("")
...
<Grid container direction="column" alignItems="center">
    <Grid item xs={12} >
        <Typography variant="h3" className={classes.heading}>Book Entry </Typography>
    </Grid>
    <Grid item xs={12}>
<form className={classes.root} noValidate autoComplete="off">
<TextField name="title" label="Title" value={title} onChange={ (e) => addTitle(e.target.value)}/>
<TextField type="date" name="date" label="Date" InputLabelProps={{ shrink: true }}  value={date} onChange={(e) => setDate(e.target.value)}/>
<TextField name="classnumber" label="Class Number"  value={classnumber} onChange={(e) => setClass(e.target.value)}/>
<TextField name="accnumber" label="Account Number" value={accnumber} onChange={(e) => setAcc(e.target.value)}/>
